...
from MyCustomWidgets import SubPage, TitleWidget, CustomButton, VerticalScrolledFrame
from MySettings import SettingsObj as stg

from .keybindspage import KeyBindsPage
from .themespage import ThemesPage

class SettingsPage(SubPage):
    """
    window that hosts all the user-end configurations of settingsconfig.json file
