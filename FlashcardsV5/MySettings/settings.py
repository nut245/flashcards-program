...
class Settings():
    def __init__(self):
        """
        pseudo-singleton class that manages the values within settingsconfig.json file
    ...
    def refresh_values(self):
        """
        instantiates new values of settingsObj properties, taken from the potentially updated settingsconfig.json file
        """
        # importing settingsconfig.json
    ...
    def update_settings_config(self, updated_value: dict):
        """
        changes the values within settingsconfig.json file

        ### Parameters
        - updated_value: dict
            - a smaller dictionary than the settingsconfig.json file, 
    ...
    def _write_to_settings_config(self, data: dict):
        """
        updates and rewrites information within settingsconfig.json file with conventional formatting
        """
    ...
    def _update(self, dictionary: dict, updated_value: dict):
        """
        navigates settingsconfig dictionary and compares values within another dictionary

        replaces/updates values under congruent dictionary keys

        ### Parameters
        - dictionary: dict
            - the settingsconfig.json file converted into python dictionary
        - updated_value: dict
